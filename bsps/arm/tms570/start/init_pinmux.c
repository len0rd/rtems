...
const uint32_t tms570_pinmmr_init_data[] = {
  ...
  /* (TM) TODO: The following registers are initialized by Halcogen for the LC43HDK. tms570_bsp_pinmmr_config
   * expects tms570_pinmmr_init_data to be a contiguous list of registers, so if these need to be
   * initialized in the future, separate calls to tms570_bsp_pinmmr_config or correct 0-padding of
   * tms570_pinmmr_init_data will be needed
   */
  // TMS570_PINMMR_REG_VAL( 80, TMS570LC4357_PINMMR_DEFAULT_INIT_LIST ),
  // TMS570_PINMMR_REG_VAL( 81, TMS570LC4357_PINMMR_DEFAULT_INIT_LIST ),
  // TMS570_PINMMR_REG_VAL( 82, TMS570LC4357_PINMMR_DEFAULT_INIT_LIST ),
  // TMS570_PINMMR_REG_VAL( 83, TMS570LC4357_PINMMR_DEFAULT_INIT_LIST ),
  // TMS570_PINMMR_REG_VAL( 84, TMS570LC4357_PINMMR_DEFAULT_INIT_LIST ),
  // TMS570_PINMMR_REG_VAL( 85, TMS570LC4357_PINMMR_DEFAULT_INIT_LIST ),
  // TMS570_PINMMR_REG_VAL( 86, TMS570LC4357_PINMMR_DEFAULT_INIT_LIST ),
  // TMS570_PINMMR_REG_VAL( 87, TMS570LC4357_PINMMR_DEFAULT_INIT_LIST ),
  // TMS570_PINMMR_REG_VAL( 88, TMS570LC4357_PINMMR_DEFAULT_INIT_LIST ),
  // TMS570_PINMMR_REG_VAL( 89, TMS570LC4357_PINMMR_DEFAULT_INIT_LIST ),
  // TMS570_PINMMR_REG_VAL( 90, TMS570LC4357_PINMMR_DEFAULT_INIT_LIST ),
  // TMS570_PINMMR_REG_VAL( 91, TMS570LC4357_PINMMR_DEFAULT_INIT_LIST ),
  // TMS570_PINMMR_REG_VAL( 92, TMS570LC4357_PINMMR_DEFAULT_INIT_LIST ),
  // TMS570_PINMMR_REG_VAL( 93, TMS570LC4357_PINMMR_DEFAULT_INIT_LIST ),
  // TMS570_PINMMR_REG_VAL( 94, TMS570LC4357_PINMMR_DEFAULT_INIT_LIST ),
  // TMS570_PINMMR_REG_VAL( 95, TMS570LC4357_PINMMR_DEFAULT_INIT_LIST ),
  // TMS570_PINMMR_REG_VAL( 96, TMS570LC4357_PINMMR_DEFAULT_INIT_LIST ),
  // TMS570_PINMMR_REG_VAL( 97, TMS570LC4357_PINMMR_DEFAULT_INIT_LIST ),
  // TMS570_PINMMR_REG_VAL( 98, TMS570LC4357_PINMMR_DEFAULT_INIT_LIST ),
  // TMS570_PINMMR_REG_VAL( 99, TMS570LC4357_PINMMR_DEFAULT_INIT_LIST ),

  // TMS570_PINMMR_REG_VAL( 161, TMS570LC4357_PINMMR_DEFAULT_INIT_LIST ),
  // TMS570_PINMMR_REG_VAL( 162, TMS570LC4357_PINMMR_DEFAULT_INIT_LIST ),
  // TMS570_PINMMR_REG_VAL( 163, TMS570LC4357_PINMMR_DEFAULT_INIT_LIST ),
  // TMS570_PINMMR_REG_VAL( 174, TMS570LC4357_PINMMR_DEFAULT_INIT_LIST ),
...
/**
 * @brief sets up pin multiplexer according to precomputed registers values (HCG:muxInit)
 */
